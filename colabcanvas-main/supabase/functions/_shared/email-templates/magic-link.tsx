...
export const MagicLinkEmail = ({
  ...
  const heading = headingOverride || `Sign in to ${name}`
  const body = bodyOverride || 'Click below to log in. This link expires shortly, so use it soon.'
  const btn = buttonOverride || 'Sign In'

  return (
    <Html lang="en" dir="ltr">
      <Head />
      <Preview>Your {name} login link</Preview>
      <Body style={main}>
