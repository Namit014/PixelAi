...
export const SignupEmail = ({
  ...
  const heading = headingOverride || 'Welcome aboard 👋'
  const body = bodyOverride || `You're one step away from creating with ${name}. Confirm your email to get started.`
  const btn = buttonOverride || 'Get Started'

  return (
    <Html lang="en" dir="ltr">
      <Head />
      <Preview>Welcome to {name} — confirm your email to get started</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={contentSection}>
            ...
            <Text style={footerNote}>
              If you didn't sign up for {name}, just ignore this email.
            </Text>
          </Section>
