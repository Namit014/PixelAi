...
import { Copy, Link, Loader2, Trash2, Users, Check, Mail, X } from "lucide-react";
  ...
  const handleGenerateLink = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Copy the link to share with collaborators.",
      });
    } catch (error: any) {
      toast({
        title: "Error",
                    ...
                    >
                      ...
                      <div className="flex gap-1">
                        <Button
                          ...
                          size="icon"
                          className="h-8 w-8"
                          onClick={() => handleCopyLink(`${window.location.origin}/project/join/${share.share_token}`)}
                        >
